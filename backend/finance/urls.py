...
urlpatterns = [
    ...
    path('products', api_views.products, name='products'),
    path('products/<str:product_id>', api_views.product_detail, name='product_detail'),
    path('products/<str:product_id>/candidates', api_views.product_candidates, name='product_candidates'),
    path('product-items', api_views.create_product_item, name='create_product_item'),
    path('product-items/<str:product_item_id>', api_views.delete_product_item, name='delete_product_item'),
